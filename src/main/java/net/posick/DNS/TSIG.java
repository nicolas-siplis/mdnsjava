...
import net.posick.DNS.utils.hexdump;
...
public class TSIG {
  ...
  public static final net.posick.DNS.Name GSS_TSIG = net.posick.DNS.Name.fromConstantString("gss-tsig.");

  /** The domain name representing the HMAC-MD5 algorithm. */
  public static final net.posick.DNS.Name HMAC_MD5 = net.posick.DNS.Name.fromConstantString("HMAC-MD5.SIG-ALG.REG.INT.");
   ...
   */
  @Deprecated public static final net.posick.DNS.Name HMAC = HMAC_MD5;

  /** The domain name representing the HMAC-SHA1 algorithm. */
  public static final net.posick.DNS.Name HMAC_SHA1 = net.posick.DNS.Name.fromConstantString("hmac-sha1.");

  /** The domain name representing the HMAC-SHA224 algorithm. */
  public static final net.posick.DNS.Name HMAC_SHA224 = net.posick.DNS.Name.fromConstantString("hmac-sha224.");

  /** The domain name representing the HMAC-SHA256 algorithm. */
  public static final net.posick.DNS.Name HMAC_SHA256 = net.posick.DNS.Name.fromConstantString("hmac-sha256.");

  /** The domain name representing the HMAC-SHA384 algorithm. */
  public static final net.posick.DNS.Name HMAC_SHA384 = net.posick.DNS.Name.fromConstantString("hmac-sha384.");

  /** The domain name representing the HMAC-SHA512 algorithm. */
  public static final net.posick.DNS.Name HMAC_SHA512 = net.posick.DNS.Name.fromConstantString("hmac-sha512.");

  private static final Map<net.posick.DNS.Name, String> algMap;

  static {
    Map<net.posick.DNS.Name, String> out = new HashMap<>();
   ...
   */
  public static net.posick.DNS.Name algorithmToName(String alg) {
    if (alg == null) {
   ...
   */
  @Deprecated
  public static String nameToAlgorithm(net.posick.DNS.Name name) {
  ...
  private final net.posick.DNS.Name alg;
   ...
   * @since 3.2
   */
  public TSIG(net.posick.DNS.Name algorithm, net.posick.DNS.Name name, String key) {
   ...
   */
  public TSIG(net.posick.DNS.Name algorithm, net.posick.DNS.Name name, byte[] keyBytes) {
   ...
   */
  public TSIG(net.posick.DNS.Name algorithm, net.posick.DNS.Name name, SecretKey key) {
   ...
   * @since 3.2
   */
  public TSIG(net.posick.DNS.Name algorithm, net.posick.DNS.Name name, SecretKey key, Clock clock) {
    this.name = name;
    this.alg = algorithm;
    this.clock = clock;
   ...
   */
  @Deprecated
  public TSIG(Mac mac, net.posick.DNS.Name name) {
    this.name = name;
    this.sharedHmac = mac;
   ...
   * @deprecated Use {@link #TSIG(net.posick.DNS.Name, net.posick.DNS.Name, SecretKey)} to explicitly specify an algorithm.
   */
  @Deprecated
  public TSIG(net.posick.DNS.Name name, byte[] key) {
   ...
   * @throws IllegalArgumentException The key data is improperly encoded
   */
  public TSIG(net.posick.DNS.Name algorithm, String name, String key) {
    byte[] keyBytes = base64.fromString(key);
    if (keyBytes == null) {
      throw new IllegalArgumentException("Invalid TSIG key string");
    }
    try {
      this.name = net.posick.DNS.Name.fromString(name, net.posick.DNS.Name.root);
   ...
   * @throws IllegalArgumentException The key name is an invalid name
   * @throws IllegalArgumentException The key data is improperly encoded
   * @deprecated Use {@link #TSIG(net.posick.DNS.Name, String, String)} to explicitly specify an algorithm.
   */
  @Deprecated
   ...
   */
  public net.posick.DNS.TSIGRecord generate(net.posick.DNS.Message m, byte[] b, int error, net.posick.DNS.TSIGRecord old) {
   ...
   * @param error The error
   * @param old If this message is a response, the TSIG from the request
   * @param fullSignature {@code true} if this {@link net.posick.DNS.TSIGRecord} is the to be added to the first of
   ...
   * @since 3.2
   */
  public net.posick.DNS.TSIGRecord generate(
          net.posick.DNS.Message m, byte[] b, int error, net.posick.DNS.TSIGRecord old, boolean fullSignature) {
    Instant timeSigned;
    ...
    Duration fudge;
    int fudgeOption = net.posick.DNS.Options.intValue("tsigfudge");
    ...
    byte[] other = null;
    if (error == Rcode.BADTIME) {
      out = new net.posick.DNS.DNSOutput(6);
      writeTsigTime(clock.instant(), out);
      other = out.toByteArray();
    }

    return new net.posick.DNS.TSIGRecord(
        name,
        DClass.ANY,
        0,
        alg,
   ...
   * @param old If this message is a response, the TSIG from the request
   */
  public void apply(net.posick.DNS.Message m, net.posick.DNS.TSIGRecord old) {
   ...
   * @param old If this message is a response, the TSIG from the request
   */
  public void apply(net.posick.DNS.Message m, int error, net.posick.DNS.TSIGRecord old) {
   ...
   * @since 3.2
   */
  public void apply(net.posick.DNS.Message m, net.posick.DNS.TSIGRecord old, boolean fullSignature) {
   ...
   * @since 3.2
   */
  public void apply(net.posick.DNS.Message m, int error, net.posick.DNS.TSIGRecord old, boolean fullSignature) {
    Record r = generate(m, m.toWire(), error, old, fullSignature);
    m.addRecord(r, net.posick.DNS.Section.ADDITIONAL);
    m.tsigState = net.posick.DNS.Message.TSIG_SIGNED;
  }
   ...
   *     all TSIG variables (rfc2845, 3.4.2.) should be included in the signature. {@code false} for
   *     subsequent messages with reduced TSIG variables set (rfc2845, 4.4.).
   * @deprecated use {@link #apply(net.posick.DNS.Message, net.posick.DNS.TSIGRecord, boolean)}
   */
  @Deprecated
  public void applyStream(net.posick.DNS.Message m, net.posick.DNS.TSIGRecord old, boolean fullSignature) {
    apply(m, Rcode.NOERROR, old, fullSignature);
  }
   ...
   * @see Rcode
   * @deprecated use {@link #verify(net.posick.DNS.Message, byte[], net.posick.DNS.TSIGRecord)}
   */
  @Deprecated
  public byte verify(net.posick.DNS.Message m, byte[] b, int length, net.posick.DNS.TSIGRecord old) {
   ...
   * @see Rcode
   */
  public int verify(net.posick.DNS.Message m, byte[] b, net.posick.DNS.TSIGRecord old) {
   ...
   * @since 3.2
   */
  public int verify(net.posick.DNS.Message m, byte[] b, net.posick.DNS.TSIGRecord old, boolean fullSignature) {
    m.tsigState = net.posick.DNS.Message.TSIG_FAILED;
    net.posick.DNS.TSIGRecord tsig = m.getTSIG();
    if (tsig == null) {
    ...
    m.getHeader().decCount(net.posick.DNS.Section.ADDITIONAL);
    ...
    m.tsigState = net.posick.DNS.Message.TSIG_VERIFIED;
  ...
  private static void hmacAddSignature(Mac hmac, net.posick.DNS.TSIGRecord tsig) {
    byte[] signatureSize = net.posick.DNS.DNSOutput.toU16(tsig.getSignature().length);
    if (log.isTraceEnabled()) {
  ...
  private static void writeTsigTimersVariables(Instant instant, Duration fudge, net.posick.DNS.DNSOutput out) {
  ...
  public static class StreamVerifier {
    ...
    private net.posick.DNS.TSIGRecord lastTSIG;

    /** Creates an object to verify a multiple message response */
    public StreamVerifier(TSIG tsig, net.posick.DNS.TSIGRecord queryTsig) {
      key = tsig;
      nresponses = 0;
      lastTSIG = queryTsig;
    }
     ...
     * @see Rcode
     */
    public int verify(net.posick.DNS.Message m, byte[] b) {
