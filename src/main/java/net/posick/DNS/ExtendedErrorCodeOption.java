...
public class ExtendedErrorCodeOption extends EDNSOption {
  ...
  /**
   * The resolver attempted to perform DNSSEC validation, but a {@link net.posick.DNS.DNSKEYRecord} {@link net.posick.DNS.RRset}
   * contained only unsupported DNSSEC algorithms.
   */
  public static final int UNSUPPORTED_DNSKEY_ALGORITHM = 1;

  /**
   * The resolver attempted to perform DNSSEC validation, but a {@link net.posick.DNS.DSRecord} {@link net.posick.DNS.RRset}
  ...
  private static final net.posick.DNS.Mnemonic codes =
      new net.posick.DNS.Mnemonic("EDNS Extended Error Codes", net.posick.DNS.Mnemonic.CASE_SENSITIVE);
