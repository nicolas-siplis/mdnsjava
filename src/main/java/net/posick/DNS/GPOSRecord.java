 ...
 * limited early version of {@link net.posick.DNS.LOCRecord})
 *
...
public class GPOSRecord extends Record {
   ...
   */
  public GPOSRecord(
          net.posick.DNS.Name name, int dclass, long ttl, double longitude, double latitude, double altitude) {
   ...
   */
  public GPOSRecord(
          net.posick.DNS.Name name, int dclass, long ttl, String longitude, String latitude, String altitude) {
    super(name, Type.GPOS, dclass, ttl);
    try {
