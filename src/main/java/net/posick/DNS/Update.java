...
public class Update extends Message {
  ...
  private final net.posick.DNS.Name origin;
   ...
   */
  public Update(net.posick.DNS.Name zone, int dclass) {
    super();
    if (!zone.isAbsolute()) {
      throw new RelativeNameException(zone);
    }
    DClass.check(dclass);
    getHeader().setOpcode(net.posick.DNS.Opcode.UPDATE);
   ...
   * @param zone The name of the zone being updated.
   */
  public Update(net.posick.DNS.Name zone) {
    this(zone, DClass.IN);
  }
   ...
   */
  public void present(net.posick.DNS.Name name) {
   ...
   */
  public void present(net.posick.DNS.Name name, int type) {
   ...
   */
  public void present(net.posick.DNS.Name name, int type, String record) throws IOException {
   ...
   * @throws IOException The record could not be parsed.
   */
  public void present(net.posick.DNS.Name name, int type, net.posick.DNS.Tokenizer tokenizer) throws IOException {
   ...
   */
  public void absent(net.posick.DNS.Name name) {
   ...
   */
  public void absent(net.posick.DNS.Name name, int type) {
   ...
   * @throws IOException The record could not be parsed.
   */
  public void add(net.posick.DNS.Name name, int type, long ttl, String record) throws IOException {
   ...
   * @throws IOException The record could not be parsed.
   */
  public void add(net.posick.DNS.Name name, int type, long ttl, net.posick.DNS.Tokenizer tokenizer) throws IOException {
  ...
  public void delete(net.posick.DNS.Name name, int type) {
   ...
   * @throws IOException The record could not be parsed.
   */
  public void delete(net.posick.DNS.Name name, int type, String record) throws IOException {
   ...
   * @throws IOException The record could not be parsed.
   */
  public void delete(net.posick.DNS.Name name, int type, net.posick.DNS.Tokenizer tokenizer) throws IOException {
  ...
  public <T extends Record> void delete(net.posick.DNS.RRset rrset) {
   ...
   * @throws IOException The record could not be parsed.
   */
  public void replace(net.posick.DNS.Name name, int type, long ttl, String record) throws IOException {
    delete(name, type);
