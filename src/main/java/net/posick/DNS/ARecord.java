...
public class ARecord extends Record {
   ...
   */
  public ARecord(net.posick.DNS.Name name, int dclass, long ttl, InetAddress address) {
    super(name, Type.A, dclass, ttl);
    if (net.posick.DNS.Address.familyOf(address) != net.posick.DNS.Address.IPv4) {
  ...
  protected void rdataFromString(Tokenizer st, Name origin) throws IOException {
    addr = fromArray(st.getAddressBytes(net.posick.DNS.Address.IPv4));
  }
