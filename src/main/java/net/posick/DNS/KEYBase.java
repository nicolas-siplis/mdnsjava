...
abstract class KEYBase extends Record {
  ...
  public int getFootprint() {
    ...
    if (alg == net.posick.DNS.DNSSEC.Algorithm.RSAMD5) {
   ...
   *
   * @throws net.posick.DNS.DNSSEC.DNSSECException The key could not be converted.
   */
  public PublicKey getPublicKey() throws net.posick.DNS.DNSSEC.DNSSECException {
    if (publicKey != null) {
      return publicKey;
    }
