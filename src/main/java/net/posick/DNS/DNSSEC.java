 ...
 *
 * @see RRSIGRecord
 * @see net.posick.DNS.DNSKEYRecord
...
public class DNSSEC {
   ...
   */
  public static byte[] digestRRset(RRSIGRecord rrsig, net.posick.DNS.RRset rrset) {
   ...
   */
  public static byte[] digestMessage(net.posick.DNS.SIGRecord sig, Message msg, byte[] previous) {
    DNSOutput out = new DNSOutput();
    digestSIG(out, sig);
   ...
   */
  public static void verify(net.posick.DNS.RRset rrset, RRSIGRecord rrsig, net.posick.DNS.DNSKEYRecord key)
      throws DNSSECException {
   ...
   * @throws SignatureVerificationException The signature does not verify.
   * @throws DNSSECException Some other error occurred.
   * @deprecated use {@link #verify(net.posick.DNS.RRset, RRSIGRecord, net.posick.DNS.DNSKEYRecord, Instant)}
   */
  @Deprecated
  public static void verify(net.posick.DNS.RRset rrset, RRSIGRecord rrsig, net.posick.DNS.DNSKEYRecord key, Date date)
      throws DNSSECException {
   ...
   * @throws DNSSECException Some other error occurred.
   */
  public static void verify(net.posick.DNS.RRset rrset, RRSIGRecord rrsig, net.posick.DNS.DNSKEYRecord key, Instant date)
      throws DNSSECException {
   ...
   * @deprecated use {@link #sign(net.posick.DNS.RRset, net.posick.DNS.DNSKEYRecord, PrivateKey, Instant, Instant)}
   */
  @Deprecated
  public static RRSIGRecord sign(
          net.posick.DNS.RRset rrset, net.posick.DNS.DNSKEYRecord key, PrivateKey privkey, Date inception, Date expiration)
      throws DNSSECException {
   ...
   * @throws DNSSECException Some other error occurred.
   * @return The generated signature
   * @deprecated use {@link #sign(net.posick.DNS.RRset, net.posick.DNS.DNSKEYRecord, PrivateKey, Instant, Instant, String)}
   */
  @Deprecated
  public static RRSIGRecord sign(
      net.posick.DNS.RRset rrset,
      net.posick.DNS.DNSKEYRecord key,
      PrivateKey privkey,
      Date inception,
      Date expiration,
      String provider)
   ...
   */
  public static RRSIGRecord sign(
          net.posick.DNS.RRset rrset, net.posick.DNS.DNSKEYRecord key, PrivateKey privkey, Instant inception, Instant expiration)
      throws DNSSECException {
  ...
  static net.posick.DNS.SIGRecord signMessage(
      Message message,
      net.posick.DNS.SIGRecord previous,
      KEYRecord key,
      PrivateKey privkey,
      Instant inception,
      Instant expiration)
    ...
    net.posick.DNS.SIGRecord sig =
        new net.posick.DNS.SIGRecord(
            Name.root,
            DClass.ANY,
            0,
            0,
  ...
  static void verifyMessage(
          Message message, byte[] bytes, net.posick.DNS.SIGRecord sig, SIGRecord previous, KEYRecord key, Instant now)
      throws DNSSECException {
    ...
    net.posick.DNS.Header header = message.getHeader().clone();
    header.decCount(Section.ADDITIONAL);
    out.writeByteArray(header.toWire());

    out.writeByteArray(bytes, net.posick.DNS.Header.LENGTH, message.sig0start - Header.LENGTH);
