...
import net.posick.DNS.InvalidDClassException;
...
public final class DClass {
  ...
  private static class DClassMnemonic extends net.posick.DNS.Mnemonic {
  ...
  private static final net.posick.DNS.Mnemonic classes = new DClassMnemonic();
   ...
   *
   * @throws net.posick.DNS.InvalidDClassException The class is out of range.
   */
  public static void check(int i) {
    if (i < 0 || i > 0xFFFF) {
      throw new net.posick.DNS.InvalidDClassException(i);
    }
  }
