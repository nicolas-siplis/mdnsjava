...
final class TypeBitmap implements Serializable {
  ...
  public TypeBitmap(net.posick.DNS.Tokenizer st) throws IOException {
    this();
    while (true) {
  ...
  private static void mapToWire(net.posick.DNS.DNSOutput out, TreeSet<Integer> map, int mapbase) {
