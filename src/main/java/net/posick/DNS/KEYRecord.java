...
public class KEYRecord extends KEYBase {
  ...
  public static class Protocol {
    ...
    private static final net.posick.DNS.Mnemonic protocols = new net.posick.DNS.Mnemonic("KEY protocol", net.posick.DNS.Mnemonic.CASE_UPPER);
  ...
  public static class Flags {
    ...
    private static final net.posick.DNS.Mnemonic flags = new net.posick.DNS.Mnemonic("KEY flags", net.posick.DNS.Mnemonic.CASE_UPPER);
   ...
   */
  public KEYRecord(net.posick.DNS.Name name, int dclass, long ttl, int flags, int proto, int alg, byte[] key) {
   ...
   */
  public KEYRecord(net.posick.DNS.Name name, int dclass, long ttl, int flags, int proto, int alg, PublicKey key)
      throws net.posick.DNS.DNSSEC.DNSSECException {
    super(name, Type.KEY, dclass, ttl, flags, proto, alg, net.posick.DNS.DNSSEC.fromPublicKey(key, alg));
    publicKey = key;
  }
