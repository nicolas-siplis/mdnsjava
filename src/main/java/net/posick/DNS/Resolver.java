...
public interface Resolver {
   ...
   *     net.posick.DNS.SimpleResolver#DEFAULT_EDNS_PAYLOADSIZE}) is used.
   ...
   * @see net.posick.DNS.OPTRecord
   */
  void setEDNS(int version, int payloadSize, int flags, List<net.posick.DNS.EDNSOption> options);
   ...
   * #sendAsync(net.posick.DNS.Message)} or {@link #sendAsync(net.posick.DNS.Message, Executor)} instead.
   *
   * @param query The query to send.
   * @return The response
   * @throws IOException An error occurred while sending or receiving.
   */
  default net.posick.DNS.Message send(net.posick.DNS.Message query) throws IOException {
    try {
      CompletableFuture<net.posick.DNS.Message> result = sendAsync(query).toCompletableFuture();
   ...
   *
   * <p>The default implementation calls the deprecated {@link #sendAsync(net.posick.DNS.Message,
   * net.posick.DNS.ResolverListener)}. Implementors must override at least one of the {@code sendAsync} methods or
   * a stack overflow will occur.
   *
   * @param query The query to send.
   * @return A future that completes when the query is finished.
   */
  default CompletionStage<net.posick.DNS.Message> sendAsync(net.posick.DNS.Message query) {
  ...
  default CompletionStage<net.posick.DNS.Message> sendAsync(net.posick.DNS.Message query, Executor executor) {
    CompletableFuture<net.posick.DNS.Message> f = new CompletableFuture<>();
    sendAsync(
        query,
        new net.posick.DNS.ResolverListener() {
          @Override
          public void receiveMessage(Object id, net.posick.DNS.Message m) {
            f.complete(m);
          }
   ...
   *
   * <p>The default implementation calls {@link #sendAsync(net.posick.DNS.Message)}. Implementors must override at
   * least one of the {@code sendAsync} methods or a stack overflow will occur.
   *
   * @param query The query to send
   * @param listener The object containing the callbacks.
   * @return An identifier, which is also a parameter in the callback
   * @deprecated Use {@link #sendAsync(net.posick.DNS.Message)}
   */
  @Deprecated
  default Object sendAsync(net.posick.DNS.Message query, ResolverListener listener) {
