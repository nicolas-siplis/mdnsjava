...
public class TKEYRecord extends Record {
  private net.posick.DNS.Name alg;
   ...
   * @param key The shared secret
   * @param other The other data field. Currently unused responses.
   * @deprecated use {@link #TKEYRecord(net.posick.DNS.Name, int, long, net.posick.DNS.Name, Instant, Instant, int, int, byte[],
   *     byte[])}
   */
  @Deprecated
  public TKEYRecord(
  ...
  protected void rrFromWire(DNSInput in) throws IOException {
    alg = new net.posick.DNS.Name(in);
