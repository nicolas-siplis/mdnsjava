...
abstract class TXTBase extends Record {
  ...
  protected TXTBase(net.posick.DNS.Name name, int type, int dclass, long ttl) {
    super(name, type, dclass, ttl);
  }

  protected TXTBase(net.posick.DNS.Name name, int type, int dclass, long ttl, List<String> strings) {
    super(name, type, dclass, ttl);
    if (strings == null) {
  ...
  protected TXTBase(net.posick.DNS.Name name, int type, int dclass, long ttl, String string) {
