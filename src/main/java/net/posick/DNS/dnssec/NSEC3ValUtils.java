...
import static net.posick.DNS.ExtendedErrorCodeOption.DNSSEC_BOGUS;
import static net.posick.DNS.ExtendedErrorCodeOption.NSEC_MISSING;
...
import net.posick.DNS.NSEC3Record.Flags;
...
final class NSEC3ValUtils {
  ...
  private boolean validIterations(SRRset nsec, net.posick.DNS.dnssec.KeyCache keyCache) {
   ...
   */
  public boolean allNSEC3sIgnoreable(List<SRRset> nsec3s, net.posick.DNS.dnssec.KeyCache dnskeyRrset) {
