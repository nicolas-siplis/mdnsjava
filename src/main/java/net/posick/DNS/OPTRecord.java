...
public class OPTRecord extends Record {
  private List<net.posick.DNS.EDNSOption> options;
   ...
   * @see net.posick.DNS.ExtendedFlags
   */
  public OPTRecord(int payloadSize, int xrcode, int version, int flags, net.posick.DNS.EDNSOption... options) {
   ...
   * @see net.posick.DNS.ExtendedFlags
   */
  public OPTRecord(int payloadSize, int xrcode, int version, int flags, List<net.posick.DNS.EDNSOption> options) {
    this(payloadSize, xrcode, version, flags);
    if (options != null) {
  ...
  public OPTRecord(int payloadSize, int xrcode, int version, int flags) {
    super(net.posick.DNS.Name.root, Type.OPT, payloadSize, 0);
  ...
  protected void rrFromWire(DNSInput in) throws IOException {
    ...
    while (in.remaining() > 0) {
      net.posick.DNS.EDNSOption option = net.posick.DNS.EDNSOption.fromWire(in);
      options.add(option);
    }
  }
  ...
  void printPseudoSection(StringBuilder sb) {
    ...
    if (options != null) {
      for (net.posick.DNS.EDNSOption o : options) {
        sb.append("\n; ")
            .append(net.posick.DNS.EDNSOption.Code.string(o.getCode()))
            .append(": ")
  ...
  protected void rrToWire(DNSOutput out, Compression c, boolean canonical) {
    ...
    for (net.posick.DNS.EDNSOption option : options) {
      option.toWire(out);
    }
  }

  /** Gets all options in the OPTRecord. This returns a list of EDNSOptions. */
  public List<net.posick.DNS.EDNSOption> getOptions() {
    if (options == null) {
  ...
  public List<net.posick.DNS.EDNSOption> getOptions(int code) {
    if (options == null) {
      return Collections.emptyList();
    }
    List<net.posick.DNS.EDNSOption> list = new ArrayList<>();
