  ...
  public IPSECKEYRecord(
    ...
    switch (gatewayType) {
      ...
      case Gateway.IPv6:
        ...
        break;
      case Gateway.Name:
        if (!(gateway instanceof net.posick.DNS.Name)) {
          throw new IllegalArgumentException("\"gateway\" must be a DNS name");
        }
        this.gateway = checkName("gateway", (net.posick.DNS.Name) gateway);
        break;
      default:
  ...
  protected void rrFromWire(DNSInput in) throws IOException {
    ...
    switch (gatewayType) {
      ...
      case Gateway.IPv6:
        ...
        break;
      case Gateway.Name:
        gateway = new net.posick.DNS.Name(in);
        break;
      default:
  ...
  protected void rrToWire(DNSOutput out, Compression c, boolean canonical) {
    ...
    switch (gatewayType) {
      ...
      case Gateway.IPv6:
        ...
        break;
      case Gateway.Name:
        net.posick.DNS.Name gatewayName = (Name) gateway;
